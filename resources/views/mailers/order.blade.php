                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Recibo de tu pago en Programacion JJE</h1>
                                                    	...
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                                              ...
                                                              @foreach ($products as $product)
                                                                  <tr mc:repeatable>
                                                                      <td vvalign="top" class="dataTableContent" mc:edit="data_table_content00">{{ $product->title }}
                                                                      </td>
                                                                      <td valign="top" class="dataTableContent" mc:edit="data_table_content01">{{ $product->pricing}}</td>
                                                                  </tr>
                                                              @endforeach
                                                              <tr>
                                                                  <td vvalign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                                      Total
                                                                  </td>
                                                                  <td valign="top" class="dataTableContent" mc:edit="data_table_content01">{{ $order->total}}</td>
                                                              </tr>
                                                          </table>
                                                        </td>
                                                    </tr>
