                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                Se actualizo los datos de tu pedido, aqui los datos actualizados:
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                                              <tr>
                                                                  ...
                                                                  <tr mc:repeatable>
                                                                      <td vvalign="top" class="dataTableContent" mc:edit="data_table_content00">Número de guia
                                                                      </td>
                                                                      <td valign="top" class="dataTableContent" mc:edit="data_table_content01">{{ $order->guide_number}}</td>
                                                                  </tr>
                                                                  <tr mc:repeatable>
                                                                      <td vvalign="top" class="dataTableContent" mc:edit="data_table_content00">Estado
                                                                      </td>
                                                                      <td valign="top" class="dataTableContent" mc:edit="data_table_content01">{{ $order->status}}</td>
                                                                  </tr>

                                                                  <tr mc:repeatable>
                                                                      <td vvalign="top" class="dataTableContent" mc:edit="data_table_content00">Dirección
                                                                      </td>
                                                                      <td valign="top" class="dataTableContent" mc:edit="data_table_content01">{{ $order->address()}}</td>
                                                                  </tr>
                                                                  <tr mc:repeatable>
                                                                      <td vvalign="top" class="dataTableContent" mc:edit="data_table_content00">Nombre de quien recibe
                                                                      </td>
                                                                      <td valign="top" class="dataTableContent" mc:edit="data_table_content01">{{ $order->recipient_name}}</td>
                                                                  </tr>
                                                          </table>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2017 Programacion JJE, All rights reserved.</em>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
